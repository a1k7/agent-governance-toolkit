...
def generate_trace(agent_id, num_decisions=5):
    ...
    for _ in range(num_decisions):
        ...
        risk_score = random.randint(20, 50)   # 20–50 → ~50% chance >= 30
        action = {
            "id": str(uuid.uuid4()),
            "name": "refund",
...
if __name__ == "__main__":
    ...
    with open("sample_traces.jsonl", "w") as f:
        for trace in traces:
            f.write(json.dumps(trace) + "\n")
    print("Generated 100 traces with refund amounts 30k–60k, risk_score 20–50.")